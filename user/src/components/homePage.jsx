        ...
        <div className="hs-carousel relative overflow-hidden w-full min-h-[350px] bg-white rounded-lg">
          <div className="hs-carousel-body absolute top-0 bottom-0 start-0 flex flex-nowrap transition-transform duration-700 opacity-0">
            <div className="hs-carousel-slide">
              ...
              <img src="https://e0.pxfuel.com/wallpapers/603/552/desktop-wallpaper-hospital.jpg" alt="Placeholder Image" className="object-cover w-full h-full" />
              </div>
            </div>
            <div className="hs-carousel-slide">
              <div className="flex justify-center h-full bg-gray-200 p-6">
              <img src="https://e0.pxfuel.com/wallpapers/13/207/desktop-wallpaper-hospital-room-background.jpg" alt="Placeholder Image" className="object-cover w-full h-full" />
              </div>
            </div>
            <div className="hs-carousel-slide">
              <div className="flex justify-center h-full bg-gray-300 p-6">
              <img src="https://source.unsplash.com/random?hospital" alt="Placeholder Image" className="object-cover w-full h-full" />
              </div>
            </div>
          </div>
        </div>
